<div class="collapse" id="collapse-transaksi-pelanggan" style="margin-top: 5px">
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                        <div class="form-group">
                            ...
                            <select class="form-control select2 list-barang-2" style="width: 100% !important" name="barang_id[]" multiple="multiple">
                                @foreach($barang as $data)
                                    <option class="sub-barang{{$data['id']}}" value="{{ $data['id'] }}"
                                        ...
                                        data-harga_reseller="{{$data['harga_reseller']}}"
