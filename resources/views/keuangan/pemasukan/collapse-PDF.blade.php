<div class="collapse" id="collapse-exportPDF" style="margin-top: 5px">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
           <form action="{{ route('exportPDFPemasukan') }}" method="post"  target="_blank">
                {{ csrf_field() }}
               ...
               <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8 col-lg-offset-2">
                    <button class="btn btn-danger btn-block btn-flat btn-md">Export To PDF <i class="fa fa-file-pdf-o"></i></button>
               </div>
           </form>
        </div>
    </div>
